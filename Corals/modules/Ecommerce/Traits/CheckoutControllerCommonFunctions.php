...
trait CheckoutControllerCommonFunctions
{
    ...
    public
    function saveCheckoutStep($step, CheckoutRequest $request)
    {
        $cart = \ShoppingCart::getItems();
        try {
     ...
     */
    protected
    function payGatewayOrder($order, User $user, $checkoutDetails)
    {
        $this->canAccessCheckout();
     ...
     */
    protected
    function payGatewayOrderSend($order, User $user, $checkoutDetails)
    {
