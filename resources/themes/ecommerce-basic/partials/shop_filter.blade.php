<form id="filterForm">
    ...
    @if(!($brands = \Shop::getActiveBrands())->isEmpty())
        <section class="widget">
            <h3 class="widget-title">@lang('corals-ecommerce-basic::labels.template.shop.filter_brand')</h3>
    ...
    <section class="widget">
        <div class="column">
            <button class="btn btn-outline-primary btn-block btn-sm"
                    type="submit">@lang('corals-ecommerce-basic::labels.template.shop.filter')</button>
        </div>
    </section>
</form>
